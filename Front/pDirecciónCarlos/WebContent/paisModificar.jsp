...
function volver(){
	document.getElementById("modificarForm").action="../pais";
	document.getElementById("modificarForm").submit();
}
</script>
...
<body>
	...
	<form method="post" id="modificarForm" action="./modificar">
		<input type="hidden" name="id" value="${element.paisId}"> <input
			type="hidden" name="idRegion" value="${element.region.id}">
		<table>
			<tr>
				<td>Id</td>
