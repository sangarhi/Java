...
public class Singleton {
	...
	private static Singleton singleton; //aquí tendría valor null, porque es un OBJETO, si fuera un tipo primitivo HABRÍA QUE DARLE VALOR (porque es un tipo estático)
