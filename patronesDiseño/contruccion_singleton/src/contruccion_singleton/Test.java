...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println(casa2); // Son el mismo objeto, así que si cambias algo en una, afectará a la otra porque tienen lo mismo
		
		casa1.setNumBaños(1);
		System.out.println("Número de baños: " + casa2.getNumBaños());
