 ...
 *
 */
public class CrudDepartamento implements ICrudDepartamento, IConnection {
	...
	public Connection connectBBDD(int tipoConexion, String user, String password) {
		// TODO Implementar connectBBDD. Cuidadin con tipoConexion, no estoy segura de parametros
