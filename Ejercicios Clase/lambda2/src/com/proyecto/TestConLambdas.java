...
public class TestConLambdas {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * @Override public boolean test(Object objeto) { String cadena = (String)
		 * objeto;
		 * 
		 ...
		 * 
		 * @Override public boolean test(Object objeto) { Integer numero = (Integer)
		 * objeto; return ((numero == null) || numero == 0); } };
		 */
		ITest variable2 = (objeto) -> {
		 ...
		 * 
		 * @Override public boolean test(Object objeto) { return (objeto == null); } };
		 */
		
		ITest variable3 = (objeto) -> {
			return (objeto == null);
		};
