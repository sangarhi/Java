...
public class TestNIO2 {
	...
	public static void main(String[] args) throws IOException{
		...
		System.out.println("-------------------- LECTURA Y ESCRITURA DE UN FICHERO-------");
		List<String> lineas = new ArrayList<String>();
		lineas.add("Este es mi fichero");
		
		Path pathFichero = Paths.get("miFichero.txt");
		
		//Escritura de fichero
		
		Charset cs = Charset.forName("ISO-8859-1");
		 
		Files.write(pathFichero, lineas, cs, StandardOpenOption.CREATE_NEW);
		
		
		//Leer Fichero
		Files.lines(pathFichero).forEach(System.out::println);
